...
import { Search, RefreshCw, Briefcase, ArrowUpDown } from 'lucide-react';
import { DashboardLayout } from '@/components/DashboardLayout';
import { JobCard } from '@/components/JobCard';
import JobDetailsDialog from '@/components/JobDetailsDialog';
import { useJobs } from '@/hooks/useJobs';
import { Job } from '@/types/job';
import { JOB_SORT_OPTIONS, JobSortOption, sortJobs } from '@/lib/format';
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto sm:flex-1">
          ...
          <div className="relative w-full sm:w-52">
            ...
            <select
              ...
              className="w-full appearance-none bg-white border border-neutral-300 pl-10 pr-8 py-2.5 text-sm focus:outline-none focus:border-black transition-colors cursor-pointer"
            >
